...
import { CaptureVisionRouter, CameraEnhancer, Resolution, CameraView, CapturedResult, EnumCapturedResultItemType, BarcodeResultItem } from 'dynamsoft-barcode-reader-bundle';
